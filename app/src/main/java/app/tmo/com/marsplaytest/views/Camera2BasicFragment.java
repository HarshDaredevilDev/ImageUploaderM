...
public class Camera2BasicFragment extends androidx.fragment.app.Fragment
...
//    }
    ...
    public Camera2BasicFragment(Activity activity)
    {
        this.cropAndUpload=(Camera)activity;
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        view.findViewById(R.id.imgCapture).setOnClickListener(this);
        view.findViewById(R.id.imgSwitch).setOnClickListener(this);
        flash=(ImageButton)view.findViewById(R.id.flash_on);
    ...
    private void takePicture() {
        if(mCameraId.equalsIgnoreCase(CAMERA_BACK))
        {
            lockFocus();
        }else{
            captureStillPicture();
...
//                            .show();
    ...
    private class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                output.write(bytes);
                cropAndUpload.openCropActivity(mFile);
    ...
    public interface CropAndUpload{
